 ...
 *
 * @return 操作状态，RT_EOK on OK，-OK_ERROR on error
 */
...
/**
 * 该函数将让出当前线程处理器，调度器选择最高优先级的线程运行。当前让出处理器之后，
 * 当前线程还是在就绪态。
 * 
 * @return RT_EOK
 */
